...
class PersonController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        $infoMenu = [];
        $menu = new Menu;
        $infoMenu = $menu->getInfoMenu('app/Manage_your_Account/Personal_information');
        ...
        try {
            ...
            return view('app.settings.operatingUnit.index', ['operatingUnit' => $data, 'infoMenu' => $infoMenu, 'utilServices' => $utilServices]);
        ...
        */
        return view('app.manage_your_account.person',['infoMenu' => $infoMenu]);
    }
